...
(* This is the start of the code for module Standard. The rest of the code is in
   r.ml.part2, which is generated by the R script rstdenv.R. *)

(** Module type containing properly set up R environment variables, as well as
    startup options. *)
